        ...
        <Row>
          ...
          <Col>
              <div className="details">
                  ...
                  <p> <img className="icon-pro" src={companyImg} /> {this.props.project.organization.name} </p>
                  <p> <img className="icon-pro" src={timelineImg} /> {this.props.project.timeline} </p>
                  <p> <img className="icon-pro" src={teamImg} /> {this.props.project.team_size} </p>
                  <p> <img className="icon-pro" src={skillsImg} /> {this.props.project.tech_stack} </p>
              </div>
           </Col>
        </Row>
        </div>
